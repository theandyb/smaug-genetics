...
print $mdFH "srun vcftools --gzvcf /net/bipolar/lockeae/final_freeze/snps/vcfs/chr${SLURM_ARRAY_TASK_ID}/chr${SLURM_ARRAY_TASK_ID}.filtered.modified.vcf.gz --singletons --chr ${SLURM_ARRAY_TASK_ID} --out $parentdir/singletons/chr${SLURM_ARRAY_TASK_ID}sing";
